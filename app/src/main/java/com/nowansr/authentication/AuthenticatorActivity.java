...
public class AuthenticatorActivity extends AccountAuthenticatorActivity {
    ...
    private final String APPLICATION_NAME = "NowAnsr";
    ...
    public void loadRegistration() {
        Intent i = new Intent(AuthenticatorActivity.this, RegistrationActivity.class);
        startActivity(i);
    }
    ...
    public void submit() {
        ...
        new AsyncTask<String, Void, Intent>() {
            ...
            protected Intent doInBackground(String... params) {
                ...
                Log.d(LOG_TAG, "Authentication in progress...`");
